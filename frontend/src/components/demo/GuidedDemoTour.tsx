...
const TOUR_STEPS: DemoTourStep[] = [
  ...
  },
  {
    ...
    route: "/mentor",
    role: "mentor",
    target: "nav-mentor-plan-generator",
    title: "Open the AI Plan Generator",
    body: "To extend a newcomer's plan with a new period — and demo live editing — open the AI Plan Generator from the sidebar.",
    waitForClickTarget: "nav-mentor-plan-generator",
  },
  {
    id: "closing-pg-journey",
    route: "/mentor/plan-generator",
    role: "mentor",
    target: "plan-generator-journey",
    title: "The journey timeline",
    body: "The plan is split into periods. Add a new period to extend the plan with a focused chunk — for example, a fourth onboarding sprint.",
  },
  {
    id: "closing-pg-new-period",
    route: "/mentor/plan-generator",
    role: "mentor",
  ...
  },
  {
    ...
    fill: [
      { target: "period-flow-label", value: "Sprint 4 — Production readiness" },
      { target: "period-flow-goal", value: "Independent on-call rotation, comfortable shipping production changes solo with confidence." },
    ],
    waitForClickTarget: "period-flow-next",
  },
  {
    id: "closing-pg-mode-live",
    route: "/mentor/plan-generator",
    role: "mentor",
  ...
  },
  {
    ...
    advanceDelayAfterClick: 1500,
  },
  {
    id: "closing-pg-live-commit",
    route: "/mentor/plan-generator",
    role: "mentor",
    ...
    advanceDelayAfterClick: 1800,
  },
  {
    id: "closing-pg-all-tasks-tab",
    route: "/mentor/plan-generator/",
    routeMatch: "prefix",
    role: "mentor",
  ...
  },
  {
    ...
    fill: [
      { target: "mentor-task-editor-title", value: "Pair on a real staging-to-prod release with rollback rehearsal" },
    ],
  },
  {
    id: "closing-pg-task-save",
    route: "/mentor/plan-generator/",
    routeMatch: "prefix",
    role: "mentor",
    ...
    advanceDelayAfterClick: 900,
  },
  {
    id: "closing-pg-back-to-workspace",
    route: "/mentor/plan-generator/",
    routeMatch: "prefix",
    role: "mentor",
    target: "plan-breadcrumb-back",
    title: "Back to the period workspace",
    body: "Click the back arrow to return to the period workspace and publish.",
    waitForClickTarget: "plan-breadcrumb-back",
  },
  {
    id: "closing-pg-approve",
    route: "/mentor/plan-generator/",
    routeMatch: "prefix",
    role: "mentor",
